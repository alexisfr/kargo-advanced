...
find . -type f -name '*.yaml' -exec sed -E -i.bak s#https://github.com/[-_a-zA-Z0-9]+#https://github.com/${username}#g {} +
find . -type f -name '*.yaml' -exec sed -E -i.bak s#ghcr.io/[-_a-zA-Z0-9]+#ghcr.io/${username}#g {} +
